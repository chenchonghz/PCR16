...
#define LimitSwitcRgiht_Pin GPIO_PIN_2
#define LimitSwitcRgiht_GPIO_Port GPIOC
#define DoorSwitch_Pin GPIO_PIN_3
#define DoorSwitch_GPIO_Port GPIOC
#define Motor_CS_Pin GPIO_PIN_4
#define Motor_CS_GPIO_Port GPIOA
#define Motor_SCK_Pin GPIO_PIN_5
#define Motor_SCK_GPIO_Port GPIOA
#define Motor_SDO_Pin GPIO_PIN_6
#define Motor_SDO_GPIO_Port GPIOA
#define Motor_SDI_Pin GPIO_PIN_7
#define Motor_SDI_GPIO_Port GPIOA
